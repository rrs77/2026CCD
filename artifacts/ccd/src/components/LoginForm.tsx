...
export function LoginForm() {
  ...
  return (
    <div className="login-sketchbook relative min-h-[100dvh] w-full overflow-x-hidden overflow-y-auto bg-[#f3eadc]">
      {/* Full-screen open book — covers the whole login viewport */}
      <img
        src={SKETCHBOOK_IMG}
        alt=""
        aria-hidden
